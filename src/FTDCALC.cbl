      ...
      *****************************************************************
       ...
       01  UDY                     PIC 9(2).
       01  UJ                      PIC 9(7).
       01  TOTDEP                  PIC S9(11)V99 COMP-3.
       01  SHORT                   PIC S9(11)V99 COMP-3.
       01  BYPSW                   PIC X.
       01  PICSW                   PIC X.
       01  DC-PARM.
       ...
       2000-DRIVE.
           ...
           END-READ.
      *
      *    MAIN PENALTY COMPUTATION.  ONE PASS PER MODULE.  DEPOSIT
      *    TRANSACTIONS ARE READ IN KEY SEQUENCE ALONGSIDE.
      *
       3000-COMP.
           ...
           PERFORM UNTIL TEOF = "Y" OR TKEY NOT = MKEY
               IF TRN-TC = 650
                   ...
                   IF DL > ZERO
                       ...
                       END-EVALUATE
                       IF PICSW = "Y" AND DL > 15
                           MOVE 4 TO PW-TIER
                           MOVE 0.1500 TO PW-RT
                       END-IF
                       IF BYPSW = "N" AND BMF-ASSD NOT < 2500
